...
bs3_for_simple_form = "https://gist.github.com/tokenvolt/6599141/raw/09d33083102c0e4bdde1049b321ea4ca66ff1ca0/simple_form_bootstrap3.rb"

get bs3_for_simple_form, simple_form_bootstrap_path
...
if use_devise
  ...
  # modify view to show devise's error message properly with flash
  gsub_file 'app/views/layouts/application.html.erb', 'name == :error', 'name == :alert'

  devise_ja_file = "https://gist.github.com/kawamoto/4729292/raw/ec2b3e23be61b4b8f6903efedff359fd0a4b3223/devise.ja.yml"
  get devise_ja_file, "/config/locales/devise.ja.yml"
end
# notification center
# -----------------------------------------------

notification("Check configurations for devise, simple_form, bootstrap-generators..", "Rails new finished!",
              subtitle: "", use_growl: use_growl)
